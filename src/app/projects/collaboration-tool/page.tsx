...
const project = {
  ...
  description: "A comprehensive collaboration platform designed to bridge communication gaps in distributed teams.",
  imageUrl: "https://picsum.photos/seed/portfolio-project-3/1200/630.jpg",
  logoUrl: "https://picsum.photos/seed/portfolio-logo-3/130/128.jpg",
  client: "RemoteWork Solutions",
  duration: "4 months",
  role: "Product Designer",
  tools: ["Figma", "React", "Node.js", "Socket.io", "PostgreSQL"],
  overview: "Created a unified collaboration platform that combines video conferencing, document sharing, and project management in one seamless experience.",
  problem: "Remote teams struggled with fragmented tools, context switching, and poor communication across different platforms and time zones.",
  solution: "Designed an intuitive interface that integrates multiple collaboration tools with real-time synchronization and intelligent notification systems.",
  process: [
    "Stakeholder interviews and user journey mapping",
    "Feature prioritization and MVP definition",
    "Rapid prototyping and user testing",
    "Development collaboration with engineering team",
